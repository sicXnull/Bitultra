...
LIBS += $$PWD/src/secp256k1/src/libsecp256k1_la-secp256k1.o
    ...
    isEmpty(SECP256K1_LIB_PATH) {
        win32:SECP256K1_LIB_PATH=c:/bitultra/src/secp256k1/.libs
    }
    isEmpty(SECP256K1_INCLUDE_PATH) {
        win32:SECP256K1_INCLUDE_PATH=c:/bitultra/src/secp256k1/include
    }
}
...
macx:ICON = src/qt/res/icons/Bitultra.icns
macx:TARGET = "Bitultra-Qt"
