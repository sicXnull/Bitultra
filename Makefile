#############################################################################
# Makefile for building: Bitultra-qt
# Generated by qmake (3.0) (Qt 5.5.1)
# Project:  bitultra-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile bitultra-qt.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Bitultra-qt4.0.0.0
DISTDIR = /root/bitultra/build/Bitultra-qt4.0.0.0
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /root/bitultra/src/leveldb/libleveldb.a /root/bitultra/src/leveldb/libmemenv.a /root/bitultra/src/secp256k1/src/libsecp256k1_la-secp256k1.o -lminiupnpc -lssl -lcrypto -ldb_cxx -lgmp -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lQt5PrintSupport -lQt5Widgets -lQt5Gui -lQt5Network -lQt5DBus -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		bitultra-qt.pro src/qt/bitcoingui.h \
...
Makefile: bitultra-qt.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile bitultra-qt.pro
...
clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /root/bitultra/src/leveldb/libleveldb.a; cd /root/bitultra/src/leveldb ; $(MAKE) clean /root/bitultra/src/secp256k1/src/libsecp256k1_la-secp256k1.o; cd /root/bitultra/src/secp256k1; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/root/bitultra/src/leveldb/libleveldb.a: FORCE
	cd /root/bitultra/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/root/bitultra/src/secp256k1/src/libsecp256k1_la-secp256k1.o: FORCE
	cd /root/bitultra/src/secp256k1 && ./autogen.sh && ./configure --enable-module-recovery && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -D_FORTIFY_SOURCE=2 -O2"

/root/bitultra/build/build.h: FORCE
	cd /root/bitultra; /bin/sh share/genbuild.sh /root/bitultra/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/Bitultra-80.png \
		...
		src/qt/res/icons/Bitultra-16.png \
...
build/moc_bitcoingui.cpp: src/qt/bitcoingui.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I/root/bitultra -I/root/bitultra/src -I/root/bitultra/src/json -I/root/bitultra/src/qt -I/root/bitultra/src/qt/plugins/mrichtexteditor -I/root/bitultra/src/leveldb/include -I/root/bitultra/src/leveldb/helpers -I/root/bitultra/src/secp256k1/include -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtPrintSupport -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtNetwork -I/usr/include/x86_64-linux-gnu/qt5/QtDBus -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include src/qt/bitcoingui.h -o build/moc_bitcoingui.cpp
