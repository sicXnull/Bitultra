...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeBitultraAmount"))
        settings.setValue("nAnonymizeBitultraAmount", 1000);
    nAnonymizeBitultraAmount = settings.value("nAnonymizeBitultraAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeBitultraAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeBitultraAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeBitultraAmount:
            return QVariant(nAnonymizeBitultraAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeBitultraAmount:
            nAnonymizeBitultraAmount = value.toInt();
            settings.setValue("nAnonymizeBitultraAmount", nAnonymizeBitultraAmount);
            emit AnonymizeBitultraAmountChanged(nAnonymizeBitultraAmount);
            break;
        default:
            break;
        }
