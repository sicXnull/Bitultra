...
private slots:
    ...
    QString BuyBTU(QString OrderType, double Quantity, double Rate);
    QString SellBTU(QString OrderType, double Quantity, double Rate);
