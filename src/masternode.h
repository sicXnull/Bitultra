...
#define TIERED_MASTERNODES_START_BLOCK         125// tiered mns 1st block
#define TIERED_MASTERNODES_START_BLOCK_1        135// tiered mns updated 1st block
#define TIERED_MASTERNODES_START_BLOCK_2        145// tiered mns updated 2nd block
using namespace std;
...
// Masternode tiers
static std::map<int, int> masternodeTiers = map_list_of (1, 1000) (2, 5000) (3, 10000); 
static std::map<int, int> masternodeTiers1 = map_list_of (1, 1000) (2, 5000) (3, 10000);
static std::map<int, int> masternodeTiers2 = map_list_of (1, 1000) (2, 5000) (3, 10000); 
// Masternode tier rewards
static std::map<int, int> masternodeTierRewards = map_list_of (1, 75) (2, 2.75) (3, 4.75); 
static std::map<int, int> masternodeTierRewards1 = map_list_of (1, 75) (2, 2.75) (3, 4.75); 
static std::map<int, int> masternodeTierRewards2 = map_list_of (1, 0.75) (2, 2.75) (3, 4.75); 
//
// The Masternode Class. For managing the darksend process. It contains the input of the 500 BTU, signature to prove
