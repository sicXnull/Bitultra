...
int nAnonymizeBitultraAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Bitultra
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Bitultra
    // Mac: ~/Library/Application Support/Bitultra
    // Unix: ~/.Bitultra
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitultra";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Bitultra.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Bitultrad.pid"));
